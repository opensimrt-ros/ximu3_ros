...
int main(int argc, char** argv)
{
	...
	ConnectionParams cp;
	cp.parent_frame_id = parent_frame_id;
	cp.child_frame_id = own_tf_name;
	cp.div = ahrs_divisor_rate;
	cp.origin = origin;
	cp.temp_pub = temp_pub;
	cp.bat_pub = bat_pub;
	cp.bat_v_pub = bat_v_pub;
	cp.imu_pub = imu_pub;
	cp.publish_status = publish_status;
	cp.nh = nh;
